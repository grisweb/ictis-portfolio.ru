...
namespace ictis_portfolio\libs;
...
class Pagination
{
    ...
    public function getHTML()
    {
        ...
        {
            $back = "<li><a class='nav-link' href='{$this->uri}page=" . ($this->currentPage - 1) . "'>Предыдущая</a></li>";
        }
        if($this->currentPage < $this->countPages)
        {
            $forward = "<li><a class='nav-link' href='{$this->uri}page=" . ($this->currentPage + 1) . "'>Следующая</a></li>";
        }
        if($this->currentPage > 3)
        {
            $startpage = "<li><a class='nav-link' href='{$this->uri}page=1'>В начало</a></li>";
        }
        if($this->currentPage < ($this->countPages - 2))
        {
            $endpage = "<li><a class='nav-link' href='{$this->uri}page={$this->countPages}'>В конец</a></li>";
        }
